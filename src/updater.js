...
function downloadandupdate(url, name, callback) {
    ...
    try {
        ...
        https.get(`https://raw.githubusercontent.com/mrranger/-lfjn-swenfewoihg/${releasemode}/${url}`, function (res) {
...
var checkforupdate = (forceupdate, responseSteamID, compatibilityfeaturedone) => {
    try {
        ...
        var httpsrequest = https.get(`https://raw.githubusercontent.com/mrranger/-lfjn-swenfewoihg/${releasemode}/src/data.json`, function(res) {
            res.setEncoding('utf8');
            res.on('data', function(chunk) {
